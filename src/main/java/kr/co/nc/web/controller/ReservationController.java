...
public class ReservationController {
	...
	*/Model model, PaymentRequest paymentRequest) {
	...
	public String paymentinfo(PaymentRequest paymentRequest) throws IamportResponseException, IOException{
	...
	public String myReservation(@LoginUser User user ,int reservationNo ,Model model) {
